                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="#" class="color-main">Del Apotek</a></div>
                        </div>
                    </div> <!-- Search -->
                                ...
                                <div class="header_search_form_container">
                                    <form action="#" class="header_search_form clearfix"> <input type="search"
                                        ...
                                        <div class="custom_dropdown" style="display: none;">
                                            ...
                                            class="header_search_button trans_300 bg-color-main" value="Submit"><img
                        ...
                        <div class="main_nav_content d-flex flex-row">
                            ...
                            <div class="main_nav_menu">
                                <ul class="standard_dropdown main_nav_dropdown">
                                    ...
                                    <li class="hassubs"> <a href="#">Informasi<i
                                                class="fas fa-chevron-down"></i></a>
                                        <ul>
